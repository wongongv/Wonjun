...
# dock version
	...
	def update(self):
		...
		for i in self.betas_pre:
			self.rho_avg_pre = np.append(self.rho_avg_pre, [self.cal_rho(self.js(glo_var.alpha,i))])
		for i in self.betas_post:
			self.rho_avg_post = np.append(self.rho_avg_post, [self.cal_rho(self.js(glo_var.alpha,i))])
