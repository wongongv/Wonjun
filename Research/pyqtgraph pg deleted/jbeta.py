...
# dock version
	...
	def update(self):
		...
		if self.betacheck == 1:
			self.text = TextItem(html='<span style="color: #1034A6; font-size: 16pt;">\u03b2</span></div>', anchor=(0.5,1.5))
	...
	def make_right_axis(self):
		...
		self.p4_2.addItem(PlotCurveItem(self.betas_pre,self.rho_avg_pre,pen=self.rho_dash))
		self.p4_2.addItem(PlotCurveItem(self.betas_post,self.rho_avg_post,pen=self.rho_dash))
