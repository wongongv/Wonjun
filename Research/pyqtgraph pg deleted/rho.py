...
class rho:
	def __init__(self,drho):
		...
		self.set_range()
		self.rpen=mkPen('r', width=glo_var.line_width, style=QtCore.Qt.DashLine)  
		self.lpen=mkPen(color=(16,52,166), width=glo_var.line_width, style=QtCore.Qt.DashLine)
		self.realpen=mkPen('k', width=2)
		self.update()
		self.legend()
